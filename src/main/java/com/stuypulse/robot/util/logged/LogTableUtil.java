 ...
 * 
 * <p>Utility methods for reading and writing dynamically typed
 * values to and from a {@code LogTable}.
 * 
 * <p>This centralizes type handling without having to duplicate the
 * same if else logic in multiple places.
 * 
...
public final class LogTableUtil {
    ...
    /**
     * Puts a value into a {@code LogTable} with the given key, automatically
     * handling the type of the value.
     * @param table the {@code LogTable} to put the value into
     * @param key The key where the value will be stored.
     * @param value The value to store in the {@code LogTable}. If it's not a supported type, it will be converted to a string.
     */
    ...
    /**
     * Gets a value from a {@code LogTable} with the given key, automatically
     * handling the type of the value based on the provided default value.
     * @param <T> The type of the value.
     * @param table The {@code LogTable} to get the value from.
     * @param key The key where the valid is stored.
     * @param defaultValue The default value to return if the key does not exist in the {@code LogTable}.
