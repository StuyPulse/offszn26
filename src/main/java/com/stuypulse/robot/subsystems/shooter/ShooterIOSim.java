...
public final class ShooterIOSim implements ShooterIO {
    ...
    public ShooterIOSim() {
        this.leftFlywheelSim = SystemSim.of(
            new FlywheelSim(
        ...
        this.rightFlywheelSim = SystemSim.of(
            new FlywheelSim(
                LinearSystemId.createFlywheelSystem(
                    DCMotor.getKrakenX60Foc(2),
                    ShooterSettings.SHOOTER_MOI.in(KilogramSquareMeters),
        ...
        this.topLeftMotor = new TalonFXSimulation(ShooterIds.TOP_LEFT_MOTOR, ShooterSettings.LEFT_GEARING, leftFlywheelSim);
        this.bottomLeftMotor = new TalonFXSimulation(ShooterIds.BOTTOM_LEFT_MOTOR, ShooterSettings.LEFT_GEARING, leftFlywheelSim);
        ...
        this.topRightMotor = new TalonFXSimulation(ShooterIds.TOP_RIGHT_MOTOR, ShooterSettings.RIGHT_GEARING, rightFlywheelSim);
        this.bottomRightMotor = new TalonFXSimulation(ShooterIds.BOTTOM_RIGHT_MOTOR, ShooterSettings.RIGHT_GEARING, rightFlywheelSim);
        ...
        this.shooterFollowerLeft = new Follower(topLeftMotor.getDeviceID(), MotorAlignmentValue.Aligned);
        this.shooterFollowerRight = new Follower(topRightMotor.getDeviceID(), MotorAlignmentValue.Opposed);
