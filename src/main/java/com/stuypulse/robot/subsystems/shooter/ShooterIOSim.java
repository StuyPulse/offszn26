...
public final class ShooterIOSim implements ShooterIO {
  ...
  public ShooterIOSim() {
    ...
    this.bottomLeftMotor =
        new TalonFXSimulation(
            ShooterIds.BOTTOM_LEFT_MOTOR, ShooterSettings.LEFT_GEARING, leftFlywheelSim);
    ...
    this.topRightMotor =
        new TalonFXSimulation(
            ShooterIds.TOP_RIGHT_MOTOR, ShooterSettings.RIGHT_GEARING, rightFlywheelSim);
    this.bottomRightMotor =
        new TalonFXSimulation(
            ShooterIds.BOTTOM_RIGHT_MOTOR, ShooterSettings.RIGHT_GEARING, rightFlywheelSim);
