...
public interface IntakeConstants {
  public interface IntakeSettings {
    ...
    final Angle ROLLER_START_THRESHOLD = Degrees.of(10.0);
    final Angle PIVOT_PUSHDOWN_THRESHOLD = Degrees.of(15.0);
    final Current PIVOT_PUSHDOWN_CURRENT = Amps.of(-80.0);

    // Rollers
    final double INTAKE_DUTY_CYCLE = 1;
    final double OUTTAKE_DUTY_CYCLE = -1;
  ...
  public interface IntakeDeviceIds {
    ...
    final int ROLLER_LEADER = 1;

    final int ROLLER_FOLLOWER = 2;
  }
