...
public interface Field {
  ...
  Distance BEHIND_HUB_TOLERANCE_Y =
      Inches.of(12 + 2); // To extend base of triangle (colinear with back hub)

  Pose2d BEHIND_HUB_TRIANGLE_VERTEX =
